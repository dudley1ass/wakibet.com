...
import {
  ...
  PickleballTopMlpFantasyPicksThisWeekBody,
  PickleballBestPlayersForFantasyScoringBody,
  PokerWsopFantasyStrategyGuideBody,
  PickleballUnderratedPpaTourPlayersBody,
...
const BODY_BY_SLUG: Record<ArticleSlug, ComponentType> = {
  ...
  "pickleball-top-mlp-fantasy-picks-this-week": PickleballTopMlpFantasyPicksThisWeekBody,
  "pickleball-best-players-for-fantasy-scoring": PickleballBestPlayersForFantasyScoringBody,
  "poker-wsop-fantasy-strategy-guide": PokerWsopFantasyStrategyGuideBody,
  "pickleball-underrated-ppa-tour-players": PickleballUnderratedPpaTourPlayersBody,
